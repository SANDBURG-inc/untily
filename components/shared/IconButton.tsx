...
type IconButtonVariant = 'primary' | 'secondary' | 'outline-primary';
...
export const IconButton = forwardRef<HTMLButtonElement, IconButtonProps>(
    function IconButton(props, ref) {
        ...
        const { as, href, ...buttonProps } = restProps as Omit<IconButtonAsButtonProps, keyof IconButtonBaseProps | 'children'>;
        return (
