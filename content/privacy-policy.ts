...
샌드버그(이하 '회사'라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.
...
4. 회원 탈퇴 시 개인정보 처리
   - 회원 탈퇴 시 개인정보(이름, 이메일, 전화번호)는 즉시 삭제됩니다.
   - 귀하가 생성한 문서함에 다른 사용자가 제출한 서류는 해당 사용자의 권리 보호를 위해 보존됩니다.
   - 귀하가 제출자로서 제출한 서류는 문서함 관리자의 업무 처리를 위해 익명화되어 보존됩니다.
   - 익명화된 정보는 개인을 식별할 수 없으며, 개인정보보호법상 개인정보에 해당하지 않습니다.
...
- 성명 : 배호진
- 직책 : 대표
- 연락처 : 010-2413-4498, ceo@sandburg.co.kr, 0504-012-4570(FAX)
...
- 부서명 : R&D 팀
- 연락처 : 051-711-4488, contact@sandburg.co.kr, 0504-012-4570(FAX)
...
이 개인정보 처리방침은 2026년 1월 14일부터 적용됩니다.
`;
